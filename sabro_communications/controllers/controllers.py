...
#         return 'True'
    ...
    @http.route('/get/user/sabro/permission', auth="user" , csrf= False, methods=['GET','POST'])
    def getUserSabroPermission(self, **kw):
        if request.env.user.sabro_enabled and request.env.user.sabro_user:
